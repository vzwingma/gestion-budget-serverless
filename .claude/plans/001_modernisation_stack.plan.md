...
7. ✅ Spike 5a → **Gate spike dédié** (Go/No-Go) → Go donné, déclenche 5b
8. ✅ Phase 5 (5b) complète → **Gate #4 validée (2026-07-08)** → merge `feat/upgrade`→`master`, déploiement QUA puis PROD réussis → **initiative clôturée**

**Hors plan initial, ajouté en cours de route** : Phases 6/7/8 (backlog identifié pendant l'exécution) — ✅ Phase 6 complète, ✅ Phase 7 complète, Phase 8 partiellement complète (T8.2 ✅, T8.1 bloquée backport upstream — reste ouverte, sans date connue, à surveiller lors d'une prochaine initiative).

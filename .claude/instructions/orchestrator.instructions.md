...
> Contient les spécificités du projet `gestion-budget-serverless` (backend Quarkus/Java 25, architecture hexagonale multi-modules Maven, déploiement AWS Lambda natif).
...
- Cadrer le besoin utilisateur, les contraintes techniques (Quarkus/Java 25/Mutiny/CDI, architecture hexagonale, multi-modules Maven) et les critères d'acceptation.

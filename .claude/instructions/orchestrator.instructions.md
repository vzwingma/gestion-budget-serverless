...
- **Stack** : Java 21, Quarkus 3.35, Mutiny (réactif), MongoDB Panache, CDI, JAX-RS, Lombok.
...
Attendu : docs et wiki synchronisés sans réécriture inutile, liens cohérents, mention ADR si décision majeure, alignement versions (Quarkus 3.35 / Java 21) vérifié dans `pom.xml`.
